...
class LazyImage extends Component
{
     ...
     * @return string
     */
    public function imageSourcesSet()
    {
        if (! $this->internalImage())
            ...
            $dataSrcset =   $srcs['small-wide'].' 540w,';
            $dataSrcset .=  $srcs['medium-wide'].' 720w,';
            $dataSrcset .=  $srcs['large-wide'].' 960w,';
            $dataSrcset .=  $srcs['big-wide'].' 1140w,';
            $dataSrcset .=  $srcs['original'].' 1300w';
