<footer class="main-footer super-contenedor">
    ...
    <div class="footer-redes">
        ...
        <a href="https://www.facebook.com/{{ env('FACEBOOK_PAGE', '') }}/"
           target="_blank" class="link-social-facebook"
           itemprop="sameAs">
            <img src="/images/glyph/footer/facebook.svg"
                 alt="Seguinos en Facebook"
                 style="width:20px;height:20px" />
        </a>

        <a href="https://twitter.com/{{ env('TWITTER_PAGE', '') }}"
           target="_blank"
           class="link-social-twitter"
           itemprop="sameAs">
            <img src="/images/glyph/footer/twitter.svg"
                 style="width:20px;height:16.25px"
                 alt="Seguinos en Twitter" />
        </a>

        <a href="https://www.youtube.com/channel/{{ env('YOUTUBE_CHANNEL', '') }}"
           target="_blank"
           class="link-social-youtube"
           itemprop="sameAs">
            <img src="/images/glyph/footer/youtube.svg"
                 style="width:20px;height:14px"
                 alt="Seguinos en Youtube" />
        </a>

        <a href="https://www.instagram.com/{{ env('INSTAGRAM_PAGE', '') }}/"
           target="_blank"
           class="link-social-instagram"
           itemprop="sameAs">
            <img src="/images/glyph/footer/instagram.svg"
