...
<div class="mas-en-perfil"> 
	<div class="mas-en-perfil-titulo">
		<a href="//www.perfil.com">{{ __('more in') }}  <img src="https://www.perfil.com/static/css/img/logo_perfil.svg" class="img-mas-en-perfil"></a>
	</div>
	...
	@foreach ($siteNews as $site => $noticia)
		<article class="sitio-externo {{ $site }}">
			...
			<a href="{{ $noticia['pagePath'] }}" title="{{ $noticia['pageTitle'] }}" class="noticia-sitio-externo">
				<figure>
