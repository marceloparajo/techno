...
<html lang="{{ env('APP_TIME_LANGUAGE', 'en') }}" @yield('structured-data-type')>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Crimson+Pro:ital,wght@0,400;0,600;1,400;1,600&family=Oswald:wght@400;600&family=Roboto:ital,wght@0,400;0,700;1,400;1,700&display=swap" rel="stylesheet">
