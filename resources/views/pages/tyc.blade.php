...
@section('body')
    <div class="container">
        <div class="content">
            <h1>Términos, condiciones y tratamiento de la privacidad.</h1>
            ...
            <h3>Tipos de información que se obtiene</h3>
            ...
            <h3>Finalidad que se le dará a la información</h3>
            ...
            <h3>Confidencialidad de la Información - Modificación y actualización de la información.</h3>
            ...
            <h3>Confidencialidad de los menores</h3>
            ...
            <h3>Material de Asociación France Presse (AFP) – Diarios y Noticias (DyN) - Télam.</h3>
